...
from muzlin.encoders import AzureOpenAIEncoder

# Code adapted from https://github.com/aurelio-labs/semantic-router/blob/main/tests/unit/encoders/test_azure.py
...
class TestAzureOpenAIEncoder:
    ...
    def test_openai_encoder_call_success(self, openai_encoder, mocker):
        ...
        with patch('muzlin.encoders.zure.sleep', return_value=None):
    ...
    async def test_retry_logic_async(
        ...
        with patch('muzlin.encoders.zure.asleep', return_value=None):

...
from muzlin.encoders import OpenAIEncoder

# Code adapted from https://github.com/aurelio-labs/semantic-router/blob/main/tests/unit/encoders/test_openai.py
...
class TestOpenAIEncoder:
    ...
    def test_openai_encoder_init_exception(self, mocker):
        ...
        mocker.patch('openai.Client', side_effect=Exception(
    ...
    def test_openai_encoder_call_success(self, openai_encoder, mocker):
        ...
        with patch('muzlin.encoders.openai.sleep', return_value=None):
    ...
    @pytest.mark.asyncio
    @pytest.mark.skip(reason='Async methods not added yet')
    async def test_retry_logic_async(
        ...
        with patch('muzlin.encoders.openai.asleep', return_value=None):

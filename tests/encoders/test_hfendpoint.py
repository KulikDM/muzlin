...
# Code adapted from https://github.com/aurelio-labs/semantic-router/blob/main/tests/unit/encoders/test_hfendpointencoder.py
...
class TestHFEndpointEncoder:
    ...
    def test_initialization_failure_no_url(self):
        ...
        assert "HuggingFace endpoint url cannot be 'None'" in str(
            exc_info.value)
